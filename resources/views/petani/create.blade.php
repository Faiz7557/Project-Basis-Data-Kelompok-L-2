...
@section('content')
    <h2 class="text-3xl font-bold text-white mb-6">Tambah Data Petani Baru</h2>
    ...
    <div class="bg-white/30 backdrop-blur-xl p-8 rounded-2xl shadow-lg max-w-3xl mx-auto">
        ...
        <form action="{{ route('petani.store') }}" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <input type="text" name="kontak" placeholder="Masukkan Nomor Kontak" class="w-full p-2 rounded bg-white/20 border border-white/30 text-white placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-green-400">
            </div>
            <div>
                <label class="block text-white mb-1 font-semibold">Kapasitas Panen (Kg)</label>
                <input type="number" name="kapasitas_panen" placeholder="Masukkan Kapasitas" class="w-full p-2 rounded bg-white/20 border border-white/30 text-white placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-green-400">
            </div>
            <div>
