                ...
                <div class="card-body">
                    ...
                    <form class="mt-4">
                        <div class="mb-3">
                            ...
                            <select class="form-select border-0 shadow-sm" style="background: rgba(255,255,255,0.9);">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control border-0 shadow-sm" placeholder="Contoh: 1234xxxxxx" style="background: rgba(255,255,255,0.9);">
                        </div>
                        <div class="mb-4">
                            <label class="form-label text-white fw-bold">Atas Nama</label>
                            <input type="text" class="form-control border-0 shadow-sm" placeholder="Nama Pemilik Rekening" style="background: rgba(255,255,255,0.9);">
                        </div>
                        <div class="text-end">
                            <button type="button" class="btn btn-light text-success fw-bold px-4 rounded-pill shadow-sm">
