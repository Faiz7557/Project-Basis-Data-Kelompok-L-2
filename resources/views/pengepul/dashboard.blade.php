...
<div class="container-fluid p-4">
        ...
        <div class="card-body p-4 p-lg-5 d-flex flex-column flex-md-row justify-content-between align-items-center gap-3">
            <div class="text-center text-md-start">
                <h1 class="display-6 fw-bold mb-2" style="color: #1B5E20; text-shadow: 0 1px 1px rgba(255,255,255,0.8);">
                    <i class="bi bi-speedometer2 me-2 text-warning"></i>Dashboard Pengepul
                </h1>
                <p class="lead mb-0 fw-medium" style="color: #33691E;">
                    Kelola pembelian dan distribusi stok beras Anda.
                </p>
            </div>
            <div>
    ...
    <div class="row g-4 mb-4">
            ...
            <div class="card h-100">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start mb-3">
                        <div>
                            <p class="text-white-50 text-uppercase small fw-bold mb-1">Total Saldo</p>
                            <h3 class="fw-bold mb-0">Rp {{ number_format($saldo, 0, ',', '.') }}</h3>
                        </div>
                        <div class="bg-white rounded-3 p-2 text-primary">
        ...
        <!-- Stok Gudang (Pengepul) -->
        <div class="col-12 col-sm-6 col-xl-3">
            <div class="card h-100">
                 <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start mb-3">
                        <div>
                            <p class="text-white-50 text-uppercase small fw-bold mb-1">Stok Gudang</p>
                            <h3 class="fw-bold mb-0">{{ number_format($inventoryKg ?? 0) }} <span class="fs-6 fw-normal">Kg</span></h3>
                        </div>
                        <div class="bg-white rounded-3 p-2 text-info">
                ...
                <div class="card-footer bg-transparent border-top-0 pt-0 pb-4">
                     <div class="progress" style="height: 6px; background: rgba(255,255,255,0.2);">
                        <div class="progress-bar bg-white" role="progressbar" style="width: {{ min((($inventoryKg ?? 0) / $capacityKg) * 100, 100) }}%"></div>
                    </div>
                    <small class="text-white-50 mt-2 d-block">Terisi {{ round((($inventoryKg ?? 0) / $capacityKg) * 100) }}% dari {{ number_format($capacityKg) }} Kg</small>
                </div>
            </div>
        </div>
        ...
        <div class="col-12 col-sm-6 col-xl-3">
            <div class="card h-100">
                 <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start mb-3">
                        <div>
                            <p class="text-white-50 text-uppercase small fw-bold mb-1">Negosiasi Aktif</p>
                            <h3 class="fw-bold mb-0">{{ $negotiationsSummary->where('status', 'Menunggu')->count() }}</h3>
                        </div>
                        <div class="bg-white rounded-3 p-2 text-warning">
                            <i class="bi bi-chat-dots fs-4"></i>
                        </div>
                    </div>
                </div>
                <div class="card-footer bg-transparent border-top-0 pt-0 pb-4">
                    <small class="text-white">Menunggu respon Anda</small>
                </div>
            </div>
        </div>

        <!-- Kapasitas Gudang (Dummy) -->
        <div class="col-12 col-sm-6 col-xl-3">
            <div class="card h-100">
                 <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start mb-3">
                        <div>
                            <p class="text-white-50 text-uppercase small fw-bold mb-1">Kapasitas Gudang</p>
                            <h3 class="fw-bold mb-0">{{ number_format($capacityKg) }} <span class="fs-6 fw-normal">Kg</span></h3>
                        </div>
                        <div class="bg-white rounded-3 p-2 text-secondary">
                 ...
                 <div class="card-footer bg-transparent border-top-0 pt-0 pb-4">
                    ...
                    <small class="text-white-50 mt-2 d-block">Total kapasitas penyimpanan</small>
                </div>
            </div>
        </div>
    </div>
